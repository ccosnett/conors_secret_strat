...
portfolio0 = {"USDC": Decimal(50_000), "WETH": Decimal(25),"WBTC": Decimal(1)}  #, "PEPE":1_000_000_000} #"ETH": Decimal(100), #"WBTC" : Decimal(1),#"PEPE" : Decimal(1_000_000_000),}
...
backend_type = 'local'
echo_green(backend_type,'backend_type')
env = UniswapV3Env(chain, agents, date_range, pools, market_impact, backend_type)
echo_green(dashboard_server_port,'dashboard_server_port')
backtest_run(
    env=env,
    policies=[policy],
